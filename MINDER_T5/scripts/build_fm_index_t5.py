                ...
                if args.include_query:
                    ...
                    if args.query_format == 'stable':
                        ...
                        for s in queries:
                            ...
                            # llama
                            # query =query + " <|query_bos|>" + s.strip() + ' <|query_eos|>' # llama
                            
                            # T5
                            query =query + '<extra_id_97>' + s.strip() + '<extra_id_99>'
                            # print(query)
                if args.include_code:
                    code = id2code[idx]
                    code =  " || " + ' '.join([*code.strip()]) + ' @@'
...
def parse_args():
    ...
    parser.add_argument("--delim", default='<extra_id_99>') #default="@@" '<extra_id_99>' "<|title_eos|>"
